...
###########################################################################################
### How To Extract a SubString from a String In Column From the Middle ==> .str[-12:-4]
dataset_test_at['audio_filepath(numeric)'] = dataset_test_at['audio_filepath'].str.slice(0, 7)
